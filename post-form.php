...
<div id="postbox">
		...
		<div id="poststuff" class="inputarea">
			...
			<input type="text" name="posttitle" id="posttitle" value="" onfocus="this.value=(this.value=='<?php echo esc_js( __( 'Título da postagem', 'p2' ) ); ?>') ? '' : this.value;" onblur="this.value=(this.value=='') ? '<?php echo esc_js( __( 'Título da postagem', 'p2' ) ); ?>' : this.value;" />
				</div>
